...
"    sum += texture2D(yuvTexSampler, blurCoordinates[0]).g * 0.0085;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[1]).g * 0.0382;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[2]).g * 0.1114;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[3]).g * 0.2113;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[4]).g * 0.2612;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[5]).g * 0.2113;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[6]).g * 0.1114;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[7]).g * 0.0382;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[8]).g * 0.0085;              \n"
...
"    sum += texture2D(yuvTexSampler, blurCoordinates[0]).a * 0.0085;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[1]).a * 0.0382;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[2]).a * 0.1114;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[3]).a * 0.2113;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[4]).a * 0.2612;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[5]).a * 0.2113;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[6]).a * 0.1114;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[7]).a * 0.0382;              \n"
"    sum += texture2D(yuvTexSampler, blurCoordinates[8]).a * 0.0085;              \n"
