#include "./overlay_scene_effect.h"

#define LOG_TAG "OverlaySceneEffect"

OverlaySceneEffect::OverlaySceneEffect() {
	mVertexShader = OVERLAY_SCENE_VERTEX_SHADER;
	mFragmentShader = OVERLAY_SCENE_FRAG_SHADER;
}

OverlaySceneEffect::~OverlaySceneEffect() {
}

bool OverlaySceneEffect::init(){
...
/**  Template Method  **/
void OverlaySceneEffect::buildParamDefaultValue() {
	mMapParamDef.clear();
...
void OverlaySceneEffect::renderEffect(OpenglVideoFrame * inputFrame, OpenglVideoFrame * outputFrame, EffectCallback * filterCallback) {
...
//			LOGI("get success, amaroMapTexId:%d", amaroMapTexId);
	...
	GL_CHECK_ERROR("OverlaySceneEffect::renderEffect glBindFramebuffer 0 ");
}

void OverlaySceneEffect::destroy() {
