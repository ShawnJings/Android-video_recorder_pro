...
#define LOG_TAG "SoxEqualizerEffect"
...
int SoxEqualizerEffect::initChain(SOXFilterChainParam* filterChainParam) {
	SoxBaseEffect::initSignal();
	this->initEqualizerChain(filterChainParam->getEqualizerFilterParam());
	return 1;
}
