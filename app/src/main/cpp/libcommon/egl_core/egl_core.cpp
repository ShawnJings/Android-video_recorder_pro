...
int EGLCore::setPresentationTime(EGLSurface surface, khronos_stime_nanoseconds_t nsecs) {
	return pfneglPresentationTimeANDROID(display, surface, nsecs);
}
...
//    bool (*)(EGLDisplay, EGLSurface, khronos_stime_nanoseconds_t)
	pfneglPresentationTimeANDROID = reinterpret_cast<PFNEGLPRESENTATIONTIMEANDROIDPROC>(eglGetProcAddress("eglPresentationTimeANDROID"));
