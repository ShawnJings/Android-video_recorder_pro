...
import com.timeapp.shawn.recorder.pro.PacketBufferTimeEnum;
import com.timeapp.shawn.recorder.pro.Songstudio;
...
public class AudioRecordRecorderServiceImpl implements RecorderService {
	...
	public boolean initAudioRecorderProcessor(AudioEffect audioEffect) {
		...
		recordProcessor
				.initAudioBufferSize(SAMPLE_RATE_IN_HZ, (int) (SAMPLE_RATE_IN_HZ * percent), audioEffect);
		return result;
	}
